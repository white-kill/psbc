  ...
  static showDataPick(
    ...
    Picker picker = Picker(
      backgroundColor: Colors.white,
        ...
        height: 150.w + ScreenUtil().bottomBarHeight,
        ...
        cancelText: '取消',
        confirmText: '确认',
        cancelTextStyle: TextStyle(color: Colors.blueAccent, fontSize: 14.w),
        confirmTextStyle: TextStyle(color: Colors.blueAccent, fontSize: 14.w),
