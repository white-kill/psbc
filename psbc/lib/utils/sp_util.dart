...
class SpKey{
  ...
  static const String searchBillHistory = "search_bill_history";
...
extension SpExtension on String{
  ...
  void get saveSearchBillHistory => SpUtil.putString(SpKey.searchBillHistory, this);
...
String get searchBillHistoryValue => SpUtil.getString(SpKey.searchBillHistory)??'';
